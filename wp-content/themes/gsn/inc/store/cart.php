...
class GsnCart{
	public function __construct(){
		...
		add_filter( 'woocommerce_available_payment_gateways', array($this,'gsn_payment_gateway_edit'));
	}
	...
	function gsn_payment_gateway_edit($available_gateways) {
		global $woocommerce,$gsnSettingsClass;
		$setting=$gsnSettingsClass->get();
		if(empty($setting->esewaId)){
