...
class Wp_Bootstrap_Main_Menuwalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			$classes[] = 'gsn-lheader__nitem menu-item-' . $item->ID;
			...
			*/
			...
			if ( $args->has_children ) {
				...
				$atts['class']	= $atts['class'].' dropdown__link';
			} else {
				$atts['href'] = ! empty( $item->url ) ? $item->url : '';
			}
			...
			// Font Awesome icons
			if ( ! empty( $icon ) )
				$item_output .= '<a'. $attributes .'><span class="gsn-lheader__ntext">';
			else
				$item_output .= '<a'. $attributes .'><span class="gsn-lheader__ntext">';	
