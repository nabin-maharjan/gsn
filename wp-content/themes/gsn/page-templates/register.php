...
<div class="js-gsn-landing-hero gsn-landing__hero landing-hero-cntr"  style=" background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/bg.jpg');">
  	<div class="gsn-landing__logo__wrapper">
    <?php /* ?>    <div id="js-logo_svg" class="gsn-landing__logo__svg"></div> <?php */?>
		<?php /* ?> <div id="js-main-logo-svg" class="gsn-landing__logo__main">
<div  id="js-img-cntr" class="gsn-landing__logo__img">
...
<div id="js-logo-shadow" class="gsn-landing__logo__shadow"></div>
</div>   <?php */?>
