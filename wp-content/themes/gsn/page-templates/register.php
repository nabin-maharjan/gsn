	...
	<div class="landing-form-cntr clearfix close-form" id="landing-form-cntr"> 
	    <div id="login" class="landing__tab-content tab-content__login">
	      ...
	      <form name="login_form" id="login_form">
			...
			<div class="form__message login-message">
				<span>Haven't registered yet? <a href="#register">Register Here</a></span>
			</div>		
			<!-- /.form__message -->
		</div>
		...
		<div id="register" class="landing__tab-content tab-content__register">
		  ...
		  <div class="form__message register-message">
		...
		<!-- /.close-form-cntr -->
		<!-- Row start -->		    
	    <div id="gridSystemModal" class="location-modal-cntr">	      
	        <div class="location__modal-content">
	          <div class="location__modal-heading clearfix" id="close-map-modal">
	          ...
	          <div class="location__modal-footer clearfix">
	            <button type="button" class="btn btn-primary btn-set-location fr" >Set location</button>
	          </div>
	        </div>	      
	    </div>
	    <!-- Row end -->
