...
<div class="landing-hero-cntr"  style=" background-image:url('<?php echo get_template_directory_uri();?>/assets/images/bg.jpg');">
  <div class="logo-wrap">
    ...
    <div id="main-logo-svg">
    	<div  id="img_cntr">
	      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 840 521" enable-background="new 0 0 840 521" xml:space="preserve">
	        ...
	        <clipPath id="clipping">
	          <path d="M624.029,110.055c32.739,0,63.519,12.749,86.669,35.9c23.15,23.15,35.9,53.93,35.9,86.669 s-12.749,63.519-35.9,86.669c-23.15,23.15-53.93,35.9-86.669,35.9s-63.519-12.749-86.669-35.9c-23.15-23.15-35.9-53.93-35.9-86.669
				s12.749-63.519,35.9-86.669C560.51,122.804,591.29,110.055,624.029,110.055 M624.029,78.055 c-85.366,0-154.569,69.203-154.569,154.569s69.203,154.569,154.569,154.569s154.569-69.203,154.569-154.569
	        ...
	        <clipPath id="nepalClip">
	          ...
	          <path d="M839.381,481.136h-24.949V356.615h9.596l15.354,25.908v98.613H839.381z"/>
	        </clipPath>
			
			<clipPath id="shopPath">
				<path d="M569.926,239.33c0,1.703-0.247,3.216-0.739,4.538c-0.493,1.323-1.166,2.471-2.017,3.445
				...
				<path d="M616.783,229.481c0,2.622-0.319,5.356-0.958,8.202c-0.639,2.846-1.53,5.636-2.673,8.37
				...
				<path d="M665.287,232.237c0,2.017-0.269,3.911-0.807,5.681c-0.538,1.771-1.283,3.406-2.235,4.907
				...
				<path d="M713.724,232.237c0,2.824-0.426,5.468-1.277,7.933c-0.852,2.465-2.084,4.611-3.697,6.437
...
c-96.576,0.001-174.866-78.516-174.866-175.369s78.29-175.368,174.866-175.368c74.678,0,138.41,46.951,163.478,113.019l49.227-8.079
	...
	c105.168,0,193.454-72.238,217.973-169.799L276.646,256.167z"/>
        ...
        <g class="colortext" clip-path="url(#clipping)">
        ...
        <g class="nepal_text_glow" clip-path="url(#nepalClip)">
          <rect fill="#ececec" fill-opacity="0.1" width="100%" height="85%" ></rect>
        </g>
		
				<g class="nepal_text_glow" clip-path="url(#shopPath)">
          <rect fill="#ececec" fill-opacity="0.1" width="100%" height="45%" ></rect>
        </g>
      </svg>
    </div>
    <!-- /#img-cntr -->
  ...
  <!-- /.logo-wrap -->
    ...
    <!-- Login Form End --> 
    <!-- Register Form -->
    <div id="register" class="landing__tab-content tab-content__register">
